...
$(window).on("load", function () {
  ...
  switch (body.attr("data-page")) {
    ...
    case "index":
      ...
      var myAreasmallChart1 = new Chart(
        areachartsmall1,
        myareasmallchartCofig1
      );
      ...
      var myAreasmallChart2 = new Chart(
        areachartsmall2,
        myareasmallchartCofig2
      );
      ...
      var progressCirclesProject1 = new ProgressBar.Circle(progressCircle3, {
        ...
        step: function (state, circle) {
          ...
          if (value === 0) {
            ...
            circle.setText(
              value +
                "<small>%<small> <br><small class='text-muted text-dark text-uppercase'>تکمیل</small>"
            );
          }
        },
      });
    ...
    case "calendartask":
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        moreLinkContent:function(args){
            return '+'+args.num+' یتم بیشتر';
        },
        dayMaxEvents: true, // allow "more" link when too many events
        events: [
          {
            title: "تمام رویدادهای روز",
            start: "2021-09-01",
          },
          {
            title: "رویداد طولانی",
